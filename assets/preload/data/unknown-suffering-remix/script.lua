...
function onCreate()
         makeLuaSprite('win', 'achievements/FC', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Hot dog!', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'You did this without misses!', 200, 120, 40) -- change your description text
...
function onEndSong()
     if not allowend and getProperty('songMisses') < 1 then 
